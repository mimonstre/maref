      ...
      <nav className="hidden md:flex items-center gap-0.5">
        {[
          ...
          <Link
            key={item.href}
            href={item.href}
            className={"px-3 py-2 text-sm font-semibold rounded-lg transition-colors " + (item.label === "Pro" ? "text-emerald-700 hover:bg-emerald-50" : "text-gray-600 hover:text-emerald-700 hover:bg-emerald-50")}
          >
            {item.label}
          </Link>
        ))}
