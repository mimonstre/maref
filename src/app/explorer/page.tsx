      ...
      <section className="premium-hero rounded-[32px] px-6 py-7 text-white md:px-8 md:py-8">
        <div className="relative z-10 grid gap-5 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
          <div>
            ...
            <h1 className="section-title mt-4 text-4xl font-black tracking-tight md:text-5xl">Choisir un produit proprement, avant de comparer les offres.</h1>
      ...
      {false && activeCategory && (
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="rounded-full bg-blue-950 px-3 py-1.5 text-xs font-medium text-white"
          >
            {activeCat?.name}
          </button>
          {activeSubcategory && (
            <>
              <span className="text-slate-300">›</span>
              <span className="rounded-full bg-blue-950 px-3 py-1.5 text-xs font-medium text-white">
