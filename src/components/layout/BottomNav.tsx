    ...
    <>
                ...
                return (
                  <Link
                    ...
                    className={
                      ...
                      (active ? "bg-blue-50 text-blue-700 shadow-[0_10px_22px_rgba(37,99,235,0.12)]" : "text-gray-600 hover:bg-slate-50")
                    }
                  >
      ...
      >
          ...
          return (
            <Link
              ...
              className={
                ...
                (active ? "bg-blue-50 text-blue-700" : "text-gray-400 hover:text-blue-600")
              }
            >
              <item.icon className="h-5 w-5" />
        ...
        <button
          ...
          className={
            "flex flex-col items-center gap-0.5 rounded-2xl px-3 py-1.5 transition-all " +
            (showMore ? "bg-blue-50 text-blue-700" : "text-gray-400 hover:text-blue-600")
          }
        >
